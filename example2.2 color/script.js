...
async function compute() {
  ...
  const param2 = new RhinoCompute.Grasshopper.DataTree("start");
  param2.append([0], [start_slider.valueAsNumber]);

  const param3 = new RhinoCompute.Grasshopper.DataTree("end");
  param3.append([0], [end_slider.valueAsNumber]);
